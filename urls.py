...
urlpatterns = [
    ...
    url(r'^profile/(?P<username>[\w-]+)/upvoted/page/(?P<page>[0-9]+)$', main_views.profile_upvoted,
        name='profile_upvoted_page'),
    url(r'^profile/(?P<username>[\w-]+)/favorited$', main_views.profile_favorited, name='profile_favorited'),
    url(r'^profile/(?P<username>[\w-]+)/favorited/page/(?P<page>[0-9]+)$', main_views.profile_favorited,
        name='profile_favorited_page'),
